...
export default async (data, user)=>{        // {task, name, email, lastName, url_tokren, await}
    ...
    if(data.task === "SEND_VALIDATION_TOKEN"){
        ...
        if(data.from === "SIGNUP"){
            ...
            data_email.body_data = `<p>Hola ${data.name}:</p><p style="margin-bottom: 20px;">Te damos la bienvenida a Consulta Legal.<br> A continuacion te faCilitamos el código de verificación para completar la creación de la cuenta</p><div style="width: 320px;height: auto; border: 1px solid plum;border-radius: 12px;margin: 0 auto;text-align: center;background-color:aliceblue;"><p style="text-align: center;"><h2>ConsultaLegal.IO</h2></p><h3 style="text-align: center;">Codigo de Verificacion</h3><hr><h1 style="font-weight: bold;">${validation_token.token}</h1></div><div style="max-width: 70%;border: 1px solid plum; margin: 0 auto; min-height: 400px; border-radius: 12px;margin-top: 20px;"><p style="text-align: center;">Mas texto</p></div>`
        
        }else if(data.from === "LOGIN"){

            data_email.body_data = `<p>Hola ${data.name}:</p><p style="margin-bottom: 20px;">Te damos la bienvenida a Consulta Legal.<br> A continuacion te faCilitamos el código de verificación para Iniciar Sesión</p><div style="width: 320px;height: auto; border: 1px solid plum;border-radius: 12px;margin: 0 auto;text-align: center;background-color:aliceblue;"><p style="text-align: center;"><h2>ConsultaLegal.IO</h2></p><h3 style="text-align: center;">Codigo de Verificacion</h3><hr><h1 style="font-weight: bold;">${validation_token.token}</h1></div><div style="max-width: 70%;border: 1px solid plum; margin: 0 auto; min-height: 400px; border-radius: 12px;margin-top: 20px;"><p style="text-align: center;">Mas texto</p></div>`
        ...
        const data_email = {
            ...
            name: user.name,
            body_type: "html",
            body_data: `<p>Hola ${user.name}:</p><p style="margin-bottom: 20px;">Te damos la bienvenida a Consulta Legal.<br> hEMOS DETECTADO UN TRAFICO INCORRECTO DESDE TU CUENTA. TE ENVIAMOS UN LINK PARA EL CAMBIO DE LA CONTRASEÑA. ANTES DEBERAS BORRAR LAS COOKIES DE TU NAVEGADOR PARA LIMPIAR LAS SESSIONES ANTERIORES. LO PUEDES HACE BORRANDO EL HISTORIAL.</p><div style="width: 320px;height: auto; border: 1px solid plum;border-radius: 12px;margin: 0 auto;text-align: center;background-color:aliceblue;"><p style="text-align: center;"><h2>ConsultaLegal.IO</h2></p><h3 style="text-align: center;"><a href ="${gen_url_token.endpoint}">Cambiar Contraseña</a></h3><hr></div><div style="max-width: 70%;border: 1px solid plum; margin: 0 auto; min-height: 400px; border-radius: 12px;margin-top: 20px;"><p style="text-align: center;">SI NO HAS SIDO TU NO HAGAS USO DE ESTE ENLACE</p></div>`
        ...
        const data_email = {
            ...
            name: user.name,
            body_type: "html",
            body_data: `<p>Hola ${user.name}:</p><p style="margin-bottom: 20px;">Te damos la bienvenida a Consulta Legal.<br> hAZ click EN EL SIGUIENTE ENLACE PARA EL CAMBIO DE CONTRASEÑA</p><div style="width: 320px;height: auto; border: 1px solid plum;border-radius: 12px;margin: 0 auto;text-align: center;background-color:aliceblue;"><p style="text-align: center;"><h2>ConsultaLegal.IO</h2></p><h3 style="text-align: center;"><a href ="${gen_url_token.endpoint}">Cambiar Contraseña</a></h3><hr></div><div style="max-width: 70%;border: 1px solid plum; margin: 0 auto; min-height: 400px; border-radius: 12px;margin-top: 20px;"><p style="text-align: center;">SI NO HAS SIDO TU NO HAGAS USO DE ESTE ENLACE</p></div>`
